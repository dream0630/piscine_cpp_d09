...
{/* dream0630 */
    public:/* dream0630 */
        MissionCriticalError(std::string const &message,/* dream0630 */
                std::string const &component = "Unknown");/* dream0630 */
/* dream0630 */
  virtual ~MissionCriticalError() throw();/* dream0630 */
  /* dream0630 */
};/* dream0630 */
/* dream0630 */
...
{/* dream0630 */
    public:/* dream0630 */
        LifeCriticalError(std::string const &message,/* dream0630 */
                std::string const &component = "Unknown");/* dream0630 */
  virtual ~LifeCriticalError() throw();/* dream0630 */
  /* dream0630 */
};/* dream0630 */
/* dream0630 */
...
public:/* dream0630 */
  UserError(std::string const &message,/* dream0630 */
	    std::string const &component = "Unknown");/* dream0630 */
/* dream0630 */
  virtual ~UserError() throw();/* dream0630 */
};/* dream0630 */
/* dream0630 */
...
public:/* dream0630 */
  ...
  /* dream0630 */
  virtual ~CommunicationError() throw();/* dream0630 */
  /* dream0630 */
};/* dream0630 */
/* dream0630 */
#endif/* dream0630 */
